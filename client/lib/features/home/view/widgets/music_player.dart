                  ...
                  Row(
                    ...
                    children: [
                      ...
                      IconButton(
                        ...
                        iconSize: 30, // Adjust the size if needed
                        padding: const EdgeInsets.all(10),
                        onPressed: () {
                          ref.watch(currentSongNotifierProvider.notifier).previousSong();
                        },
                      ),
                      IconButton(
                      ...
                      IconButton(
                        ...
                        padding: const EdgeInsets.all(10),
                        onPressed: () {
                          ref.watch(currentSongNotifierProvider.notifier).nextSong();
                        },
                      ),
                      Padding(
                        padding: const EdgeInsets.all(10),
